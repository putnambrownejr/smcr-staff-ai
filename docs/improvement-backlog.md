...
| C2 | No handoff editor in dashboard — user cannot directly edit/save handoff notes from the UI; must use the API | **done** — Workspace handoff editor supports creating, editing, saving, archiving, and retrying failed saves; covered by `tests/e2e/test_dashboard_integrity.py` |
