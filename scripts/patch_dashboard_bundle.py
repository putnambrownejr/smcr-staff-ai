...
PATCHES: list[tuple[str, ...]] = [
    ...
    (
        ...
        "    },\n"
        "    {\n"
        '      title: "Intel prep for a planning problem",\n'
        '      chain: ["area-study-builder", "actor-network-analyst", "ipb-assistant", "information-requirements-manager"],\n'
        '      description: "Frame the operational area and civil context, map the organizations and their relationships, build a four-step IPB scaffold, then convert the gaps into a decision-linked PIR/FFIR/CIR register — approved public or scenario sources only, human review at each step.",\n'
        "    },\n"
        "    {\n"
        '      title: "Red-team the intel picture",\n'
        '      chain: ["ipb-assistant", "red-team-assumptions-challenge", "assessment-learning-advisor"],\n'
        '      description: "Stand up the IPB scaffold, pressure-test its assumptions, evidence, and competing hypotheses with the red team, then wire the surviving indicators and gaps into what the next event must actually verify.",\n'
        "    },\n"
        "  ];",
    ),
    (
