...
1. **Awareness**
   ...
   - maradmin and news tracking

2. **Readiness and edge**
   - staff planning and document generation
   - training design
   - FRAGO to CONOP flow
...
3. **Friction reduction**
   - drill prep
   - AT prep
   - calendar driven reminders (DTS / GTCC / admin)
   - communications / IT support (PKI / CAC)
   - adimistrative support
   - installation / base practical issues
   - continuity between drills
   - pme and board reminders
...
rg -n "types.Tool|name=" C:\smcr-staff-ai\chatgpt_app\main.py
```
