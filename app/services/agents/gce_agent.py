...
class GceAgent(Agent):
    def __init__(self) -> None:
        ...
        self.metadata = AgentMetadata(
            ...
            system_prompt=(
                ...
                "- LAR Battalion: 3 LAR companies (LAV-25 family) + HQ/Service company. "
                "Under Force Design, redesignating as Mobile Reconnaissance Battalions (MRBs) "
                "with Maritime Reconnaissance Companies.\n"
                "- Tanks: the Marine Corps divested all tank battalions in 2020-2021 under Force Design; "
                "armor for a MAGTF now comes from the Army or a partner, if at all.\n"
                "- Assault Amphibian Battalion: assault amphibian companies + HQ/Service company; "
                "ACV replacing AAV.\n"
                "- Combat Engineer Battalion: 3-4 engineer companies (mobility, assault, utilities) + HQ.\n"
                "- Reconnaissance: battalion Scout Platoon (replaced the Scout Sniper Platoon in 2023), "
                "Division Recon and Force Recon companies.\n"
                "(Structure as of 2026 — verify against the current T/O before briefing.)\n\n"
                ...
                "Infantry squad under the IBX30 design: 15 Marines (squad leader, assistant squad leader, "
                "squad systems operator, three 4-Marine fire teams) with organic sUAS and loitering "
                "munitions (verify current squad size). Sensor-to-shooter kill chain: squad UAS or G/ATOR "
    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        answer = (
            ...
            "- LAR Bn: 3 LAR companies + HQ/Svc — redesignating as Mobile Reconnaissance Bns under Force Design\n"
            "- Tanks: divested 2020-2021; no organic Marine armor\n"
            "- Assault Amphibian Bn: assault amphibian companies + HQ/Svc (ACV replacing AAV)\n"
            "- Engineer Bn: 3-4 engineer companies (mobility, assault, utilities) + HQ\n"
            "- Recon: battalion Scout Platoon (replaced Scout Snipers in 2023), Division Recon / Force Recon\n"
            "(as of 2026 — verify against current T/O)\n\n"
            ...
            "reserve units should understand MRBs, the 15-Marine squad, and how ISR feeds fires.\n\n"
            "Checklist:\n"
