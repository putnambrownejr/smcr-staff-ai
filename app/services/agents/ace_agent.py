...
class AceAgent(Agent):
    def __init__(self) -> None:
        ...
        self.metadata = AgentMetadata(
            ...
            system_prompt=(
                ...
                "- LAAD (Low Altitude Air Defense): close-in ground-based air defense — Stinger MANPADS "
                "and MADIS / L-MADIS counter-UAS systems (Avenger is Army, not Marine).\n"
                ...
                "6. Aerial Reconnaissance: ISR collection — MQ-9A (VMU; RQ-21 divested), F-35B sensors, "
                "FLIR pods, small UAS at the tactical level\n\n"
                ...
                "- F-35B (VMFA): ~10-16/sqn, stealth strike/CAS/AAW/ISR\n"
                "- KC-130J (VMGR): ~14/sqn, tanker/transport/Harvest HAWK armed overwatch\n"
                "(aircraft numbers are approximate as of 2026 — verify against current T/O)\n\n"
                "ACE-GCE integration:\n"
    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        answer = (
            ...
            "- LAAD: close-in ground-based air defense (Stinger MANPADS, MADIS / L-MADIS)\n"
            ...
            "6. Aerial Reconnaissance — MQ-9A (VMU), F-35B sensors, FLIR, tactical sUAS\n\n"
