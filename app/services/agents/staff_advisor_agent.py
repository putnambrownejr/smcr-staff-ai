...
ROLE_ARCHETYPES: tuple[StaffRoleArchetype, ...] = (
    ...
    StaffRoleArchetype(
        ...
        mos_depth=(
            ...
            "& Diplomacy, PRM, DRL, and proposed Bureau of Disaster & Humanitarian Response (BDHR).\n"
            ...
            "- DART teams are effectively shelved (BHA cut from ~1,300 to ~50 staff). State's "
            "proposed BDHR (2026) would rebuild DART-equivalent capability.\n"
