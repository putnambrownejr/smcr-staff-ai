    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        if is_officer:
            role_note = (
                ...
                "- You will formally report to the CO. Service Alphas unless the unit tells you otherwise.\n"
        ...
        answer = (
            ...
            "- Update your Record of Emergency Data (RED) in MOL; confirm with S-1 whether a signed copy is needed.\n"
            ...
            "What to wear:\n"
            "- Service Alphas unless told otherwise by the unit.\n"
            "- Call ahead and confirm — some units do Charlies or even cammies for check-in.\n"
            ...
            "- S-4 (Logistics): 782/deuce gear issue through the IIF (Individual Issue Facility) or unit supply.\n"
