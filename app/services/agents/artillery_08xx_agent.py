...
class Artillery08xxAdvisorAgent(Agent):
    def __init__(self) -> None:
        self.metadata = AgentMetadata(
            ...
            system_prompt=(
                ...
                "Fire support coordination measures (FSCMs, per JP 3-09 and MCTP 3-10F, formerly MCWP 3-16):\n"
                "- Permissive measures (they speed attack): CFL (coordinated fire line) — beyond the CFL, "
                "conventional surface fires may be delivered without additional coordination; short of the "
                "CFL, coordinate with the establishing HQ. FSCL (fire support coordination line) — short of "
                "the FSCL all attacks are controlled by the land/amphibious force commander; beyond it, "
                "attacking forces must inform affected commanders in time to avoid fratricide. FFA (free-fire "
                "area) — any fires without additional coordination.\n"
                "- Restrictive measures (they safeguard): NFA (no-fire area) — no fires or effects inside "
                "without establishing-HQ approval (or self-defense). RFA (restrictive fire area) — specific "
                "restrictions apply; fires exceeding them need establishing-HQ approval. RFL (restrictive "
                "fire line) — no fires or effects across the line without coordination with the affected force.\n"
                "- 'No-fire line' is an obsolete term; use NFA.\n\n"
                ...
                "MAGTF fires delivery means (as of 2026; verify current inventory):\n"
                "- 60mm mortar (M224): ~3.5 km max range, organic to rifle company, fastest response\n"
                "- 81mm mortar (M252): ~5.9 km max range, organic to weapons company/battalion, primary "
                "battalion indirect fire\n"
                "- 155mm howitzer (M777 towed): ~24 km standard, ~30 km RAP; the Marine Corps has no "
                "self-propelled howitzers (M109 retired 2005) and divested the 120mm EFSS mortar\n"
                "- HIMARS (M142): GMLRS ~70 km, ATACMS ~300 km; Force Design shifted MAGTF fires from "
                "cannon toward rocket/missile (cannon battalions reduced, HIMARS battalions added)\n"
                "- NMESIS (ground-launched Naval Strike Missile): anti-ship fires for MLR/littoral scenarios\n"
                "Mortars: short coordination chain, fastest response, best for close support. "
                "Cannon/rocket artillery: deeper range, heavier effects, requires more coordination.\n\n"
                "Fire support plan structure (in the Marine OPORD format the fire support plan is "
                "Appendix 19 to Annex C Operations — Annex F is Public Affairs; verify against MCWP 5-10): "
                "fire support tasks and purpose, fire support coordination measures (map overlay), target "
                "list (HPTs with grids, descriptions, engagement criteria), observer plan, ammunition "
                "allocation (CSR/RSR), FSCC organization and procedures, and coordination with "
                "adjacent/higher fires elements."
            ),
        )
    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        answer = (
            ...
            "Fires delivery means and ranges (as of 2026; verify current inventory):\n"
            "- 60mm mortar (M224): ~3.5 km max range, organic to rifle company, fastest response.\n"
            "- 81mm mortar (M252): ~5.9 km max range, organic to weapons co/bn, primary bn indirect fire.\n"
            "- 155mm howitzer (M777 towed): ~24 km (~30 km w/ RAP). No M109s; 120mm EFSS divested.\n"
            "- HIMARS (M142): GMLRS ~70 km, ATACMS ~300 km — the Force Design center of gravity for MAGTF fires.\n"
            "- NMESIS: ground-launched Naval Strike Missile for anti-ship fires in MLR/littoral scenarios.\n"
            ...
            "Fire support coordination measures (JP 3-09 / MCTP 3-10F, formerly MCWP 3-16):\n"
            "- Permissive — CFL: beyond it, surface fires need no additional coordination; short of it, "
            "coordinate with the establishing HQ. FSCL: short of it the land/amphibious commander controls "
            "all attacks; beyond it, inform affected commanders. FFA: fire without coordination.\n"
            "- Restrictive — NFA: no fires inside without establishing-HQ approval. RFA: fires beyond the "
            "stated restrictions need approval. RFL: no fires across without affected-force coordination.\n"
            "- 'No-fire line' is obsolete; the measure is the NFA.\n\n"
