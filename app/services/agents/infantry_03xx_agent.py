...
class Infantry03xxAdvisorAgent(Agent):
    def __init__(self) -> None:
        self.metadata = AgentMetadata(
            ...
            system_prompt=(
                ...
                "Troop Leading Steps (BAMCIS — six steps): (1) Begin planning, (2) Arrange for "
                "reconnaissance, (3) Make reconnaissance, (4) Complete the plan, (5) Issue the order, "
                "(6) Supervise. Rehearsals, inspections, and execution oversight all fall under Supervise. "
                "Steps are continuous and overlap — not strictly sequential.\n\n"
    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        answer = (
            ...
            "- TLS (BAMCIS): Begin planning → Arrange recon → Make recon → Complete plan → Issue order → "
            "Supervise (rehearsals and inspections live here).\n"
