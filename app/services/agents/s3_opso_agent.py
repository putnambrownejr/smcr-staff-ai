...
class S3OpsOAdvisorAgent(Agent):
    ...
    def run(self, input_text: str, context: AgentContext) -> AgentRunResponse:
        ...
        answer = (
            ...
            "- What fictional scenario architecture makes the training feel real without copying a live conflict?\n"
            ...
            "- Give the adversary a fake name, real motives, and believable methods.\n"
            "- Make every inject force a report, a branch, a support fight, or a command decision.\n"
